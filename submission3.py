...
# This one includes the click ip 
...
pDayAt = get_dict('DayAttributed', 'day', 'pDay', 1)
pDay = get_dict('pDay', 'day', 'pDay', 1)
...
probDF.to_csv('submissions/submission3.csv', index = False)
